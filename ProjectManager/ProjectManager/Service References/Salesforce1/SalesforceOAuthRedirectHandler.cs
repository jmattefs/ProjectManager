...
namespace ProjectManager.Salesforce1
{
    /// <summary>
    ...
    public class SalesforceOAuthRedirectHandler : HttpTaskAsyncHandler, IRequiresSessionState
    {
        ...
        public static string GetAuthorizationUrl(string targetUri = null)
        {
            return Common.FormatAuthUrl(
                 SalesforceService.GetAppSetting("Salesforce1:Domain") + "/services/oauth2/authorize",
                 ResponseTypes.Code,
                 SalesforceService.GetAppSetting("Salesforce1:ConsumerKey"),
        ...
        {
            Uri redirectUri;
            Uri.TryCreate(SalesforceService.GetAppSetting("Salesforce1:RedirectUri"), UriKind.RelativeOrAbsolute, out redirectUri);
